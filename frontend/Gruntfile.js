module.exports = function(grunt) {
	...
	var config = {
		...
		jades: [
			...
			'sections/cadastro.jade',

			'sections/main.jade',

			'sections/cadastrar-produto.jade',

			'sections/produto-lista.jade',

			'sections/editar-produto.jade',

			'sections/produto-comentarios.jade',

			'sections/comentarios.jade',

			'sections/usuario-produtos.jade',

			'sections/my-main.jade',

			'sections/my-validation.jade',

			'sections/dirPagination.tpl.jade'
				...
				files: [
					{
						...
						src: [
							...
							'angular-local-storage/dist/angular-local-storage.min.js.map',
				...
				files: [
					{
						...
						src: [
							...
							'angularUtils-pagination/dirPagination.js',
