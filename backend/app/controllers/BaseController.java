...
public class BaseController extends Controller {
	...
	protected static void renderJSONSerializer(Object model, JSONSerializer js) {
...
//			response.chunked = true;
    ...
    protected static void checkAuthenticity() {
    	...
    	final String tokenCrypt = Scope.Params.current().get("authenticityToken");
    	final String token = Crypto.decryptAES(tokenCrypt);
	...
	protected static void erro400(Exception exception, String msg) {
	...
	//  unauthorized
	@Catch(value = Exception.class, priority = 1)
	protected static void erro401(String msg) {
